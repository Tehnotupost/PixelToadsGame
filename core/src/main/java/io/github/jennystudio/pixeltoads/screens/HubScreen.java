...
public class HubScreen implements Screen {
    ...
    public HubScreen(final PixelToadsGame game, Skin skin) {
        this.game = game;
        this.skin = skin;
    ...
    private void initUI() {
        ...
        buildBtn.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                game.setScreen(new BuildMenuScreen(game, HubScreen.this, skin));
            }
        });
        runBtn.addListener(new ClickListener() {
            @Override
            public void clicked(InputEvent event, float x, float y) {
                game.setScreen(new BattleScreen(game, skin, HubScreen.this));
//                isFirstRunDone = true;
//                checkFrogAppearance();
            }
        });
